...
Finally, also the machine learning community has provided novel tools for detecting and handling outlier in a model-driven manner. A prominent approach is the use of **isolation trees** (resp. **isolation forest** [[5]](#references)).
